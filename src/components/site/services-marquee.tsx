 ...
 *   - Marquee track renders TWO copies of the list for a seamless loop
 *   - Pauses on hover (handled by .marquee-viewport:hover in globals.css)
...
export function ServicesMarquee() {
  ...
  return (
    ...
    >
      ...
      {/* Label chip on the left (desktop only) */}
      <div className="relative">
        <div className="marquee-viewport">
          <div className="marquee-track items-center gap-2 py-2.5">
            {items.map((service, i) => {
